...
//                this.raf.writeByte(END_OF_DATA);
            ...
            switch (this.header.fieldArray[j].getDataType()) {
                ...
                case 'C':
                    if (objectArray[j] != null) {
                        ...
                        buffer.put(Utils.textPadding(str_value, characterSetName, this.header.fieldArray[j].getFieldLength()));
                    } else {

                        buffer.put(Utils.textPadding("", this.characterSetName, this.header.fieldArray[j].getFieldLength()));
                    }
                ...
                case 'D':
                    if (objectArray[j] != null) {
                        ...
                        buffer.put(String.valueOf(calendar.get(Calendar.YEAR)).getBytes());
                        buffer.put(Utils.textPadding(String.valueOf(calendar.get(Calendar.MONTH) + 1), this.characterSetName, 2, Utils.ALIGN_RIGHT, (byte) '0'));
                        buffer.put(Utils.textPadding(String.valueOf(calendar.get(Calendar.DAY_OF_MONTH)), this.characterSetName, 2, Utils.ALIGN_RIGHT, (byte) '0'));
                    } else {
                ...
                case 'F':
                    ...
                    if (objectArray[j] != null) {
                        ...
                        buffer.put(Utils.doubleFormating((Double) objectArray[j], this.characterSetName, this.header.fieldArray[j].getFieldLength(), this.header.fieldArray[j].getDecimalCount()));
                    } else {

                        buffer.put(Utils.textPadding(" ", this.characterSetName, this.header.fieldArray[j].getFieldLength(), Utils.ALIGN_RIGHT));
                    }
    ...
    private void writeRecord(ByteBuffer buffer, Object[] objectArray)
            throws IOException {
        buffer.put((byte) ' ');
        for (int j = 0; j < this.header.fieldArray.length; j++) { /* iterate throught fields */
