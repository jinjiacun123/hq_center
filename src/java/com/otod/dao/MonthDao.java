...
public class MonthDao extends ParentDao {

    public List<KLineData> getBySymbol(String symbol, int num) {
        List<KLineData> list = new ArrayList<KLineData>();
        String sql = "select * from month where symbol=? order by quote_date desc limit ? ";
    ...
    public List<KLineData> getBySymbol(String symbol, int startDate, int endDate) {
        List<KLineData> list = new ArrayList<KLineData>();
        String sql = "select * from month where symbol=? and quote_date>=? and quote_date<=? order by quote_date desc";
        PreparedStatement ps = null;
        ResultSet rs = null;
        Connection con = null;
        try {
    ...
    public void save(KLineData data) {
        String sql = "insert into month (symbol,quote_date,open_price,high_price,low_price,close_price,volume,turnover) values(?,?,?,?,?,?,?,?)";
        PreparedStatement ps = null;
        Connection con = null;
        try {
            con = getConnector().getConnection();
    ...
    public void update(KLineData data) {
        String sql = "update month set quote_date=?,open_price=?,high_price=?,low_price=?,close_price=?,volume=?,turnover=? where symbol=? and quote_date=?";
        PreparedStatement ps = null;
        Connection con = null;
        try {
            con = getConnector().getConnection();
