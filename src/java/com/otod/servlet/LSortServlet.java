...
public class LSortServlet extends HttpServlet{
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String column = request.getParameter("column");//SORT_M-³É½»¶î,SORT_RAISE-ÕÇµø·ù,SORT_AMPLITUDE-Õñ·ù,SORT_TURNOVERRATE-»»ÊÖÂÊ,SORT_EARMING-ÊÐÓ¯ÂÊ
        String index  = request.getParameter("index");
        String way    = request.getParameter("way");//0-µ¹Ðò,1-ÕýÐò
    ...
    */
        ...
        //1-³É½»¶î,2-ÕÇµø·ù,3-Õñ·ù,4-»»ÊÖÂÊ,5-ÊÐÓ¯ÂÊ
        if(Markets != null){
